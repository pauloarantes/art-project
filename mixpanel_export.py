...
data = api.request(['export'], {
	#put your event info here! Leaving empty exports all events that meet property requirements
	# 'event': ['_V2 User completed purchase'],
	'from_date': from_date,
	'to_date': to_date
	# 'where': '"5.8.1" in string(properties["$app_release"])'
	})
